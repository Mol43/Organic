    ...
    <nav className="flex items-center justify-between p-5 bg-gray-100 text-[#274C5B] shadow-md z-10">
      ...
      <div className="flex items-center space-x-8">
        ...
        >
          <a
            href="#"
            className="text-gray-700 flex items-center gap-1 hover:text-gray-900"
          >
            Pages
            {isArrowUp ? (
              <FaChevronUp size={10} />
        ...
        <Link to="/news" className="text-gray-700 hover:text-gray-900">
          News
        </Link>
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="p-2 rounded-full text-[#274C5B] flex items-center">
          <div className='bg-[#274C5B] w-8 h-8 rounded-full text-white flex justify-center items-center'>
